<div id="alertsContainer" class="fixed z-[99] inset-0 min-h-screen sm:ml-[80px] flex flex-col mt-[-800px] justify-end items-center space-y-4 px-4 py-6 sm:items-end sm:p-6 pointer-events-none"></div>
