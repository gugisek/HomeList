...
if(isset($_SESSION['alert'])){
        ...
        <div class="p-4">
          <div class="flex items-center">
            ...
            <div class="ml-4 flex flex-shrink-0">
              <button type="button" onclick="alertClose()" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2">
  ...
  echo '
    function alertClose() {
      document.querySelector(".pointer-events-none").classList.add("opacity-0","-translate-y-4", "scale-y-0");
    }
    function alert_time() {
