    ...
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      <form class="space-y-6" action="scripts/login/login_script.php" method="POST">
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" type="email" autocomplete="email" required class=" px-4 block w-full rounded-xl border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 outline-green-400 duartion-150 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="password" name="password" type="password" autocomplete="current-password" required class="px-4 block w-full rounded-xl border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 outline-green-400 duartion-150 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div>
          <button type="submit" class="flex w-full mt-8 items-center justify-center flex flex-row items-center justify-center gap-2 text-sm font-semibold leading-6 text-black hover:bg-green-100 px-8 py-2 bg-gray-100 rounded-xl hover:text-green-500 druation-150 active:scale-95 transition-all">Zaloguj</button>
        </div>
      </form>
