<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 mt-[8vh]">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      ...
      <form class="space-y-6" action="scripts/login/login_script.php" method="POST">
        ...
        <div>
          ...
          <div class="mt-2 relative">
                    <input
                      ...
                      value=""
                      placeholder=""
                      class="duration-150 px-4 block w-full rounded-xl border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 outline-green-400 duartion-150 focus:ring-inset focus:ring-green-300 sm:text-sm sm:leading-6"
                      required
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 rounded duration-150" checked>
            <label for="remember-me" class="ml-3 block text-sm leading-6 text-gray-900 cursor-pointer">Zapamiętaj dane</label>
          </div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Nie masz konta?
      <a href="register.php" class="font-semibold leading-6 text-green-400 hover:text-green-300 duration-150">Zarejestruj się 😎</a>
    </p>
  </div>
</div>
<script>
