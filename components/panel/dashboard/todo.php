...
<ul role="list" class="divide-y divide-white/5 h-full">
    ...
    <div class="text-xs text-gray-400 text-center w-full flex items-center justify-center pb-4">
      ...
      HomeList - version 0.3, powered by <a href="https://rgbpc.pl/" target="_blank" class="ml-1 duration-300"><span class="text-red-600">R</span><span class="text-green-600">G</span><span class="text-blue-600">B</span>pc.pl</span></a>
    </div>
</section>
