...
<section class="font-[poppins]">
    ...
    <div class="-mt-10">
        <h1 class="text-lg font-semibold font-[poppins]">Przenieś na inną listę</h1>
    </div>

    <div class="mt-4 flex md:flex-row flex-col gap-2">
        <div class="w-full">
            <label for="move_element_name" class="ml-px block pl-2 text-sm font-medium leading-6 text-gray-900">Zadanie</label>
            <div class="mt-2">
                <h1 name="move_element_name" id="move_element_name" class="py-1.5 w-full px-4 text-md font-medium focus:ring-0 focus:outline-0 focus:bg-[#1c1c1c] focus:border-[#1c1c1c] focus:shadow-xl duration-150 font-medium focus:font-normal focus:text-white"><?=$row['title']?></h1>
            </div>
        </div>
    </div>
    ...
    <div class="mt-4 flex md:flex-row flex-col gap-2">
        <div class="w-full">
            <label for="move_element_list" class="ml-px block pl-2 text-sm font-medium leading-6 text-gray-900">Lista</label>
            <div class="mt-2">
                <select name="move_element_list" id="move_element_list" class="border rounded-xl py-1.5 w-full px-4 text-sm border-gray-400 focus:ring-0 focus:outline-0 focus:bg-[#1c1c1c] focus:border-[#1c1c1c] focus:shadow-xl duration-150 font-medium focus:font-normal focus:text-white">
