...
<div id="info_list_loading"></div>
    <h1 class="font-[poppins] dark:text-gray-200 font-semibold text-lg pr-8"><?=$row['full_name']?></h1>
    <p class="pt-4 text-wrap"></p>
    <div class="flex flex-col">
        <div class="flex md:flex-row flex-col gap-2">
            <div class="w-full">
                <label for="" class="ml-px block pl-2 text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Kod zaproszenia listy</label>
                ...
                <label for="" class="mt-2 ml-px block pl-2 text-sm leading-6 text-gray-900 dark:text-gray-200">Lista stworzona przez: <span class="font-medium"><?=$row['full_usr_name']?></span></label>
            </div>
        </div>
        <?php
        session_start();
        ...
        <div class="mt-4 flex md:flex-row flex-col gap-2">
            <div class="w-full">
                <label for="edit_list_name" class="ml-px block pl-2 text-sm font-medium leading-6 text-gray-900 dark:text-gray-200">Nazwa listy</label>
                <div class="mt-2">
                    <input name="edit_list_name" id="edit_list_name" type="text" value="'.$row['full_name'].'" placeholder="Wymagane" class="border dark:bg-[#3d3d3d] dark:text-gray-200 dark:border-[#3d3d3d] rounded-xl py-1.5 w-full px-4 text-sm border-gray-400 focus:ring-0 focus:outline-0 focus:bg-[#1c1c1c] focus:border-[#1c1c1c] focus:shadow-xl duration-150 font-medium focus:font-normal focus:text-white" required>
                </div>
            </div>
        </div>
