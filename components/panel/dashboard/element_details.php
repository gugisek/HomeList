    ...
    <div class=" flex gap-2">
            ...
            switch ($row['status_id']) {
                case 1:
                    ...
                    <button onclick="popupDetailsElementOpenClose();openPopupMoveElement('.$row['id'].')" style="box-shadow: 0px 5px 15px 0px rgba(66, 68, 90, 0.6);" class="active:scale-95 items-center duration-150 inline-flex justify-center active:scale-95 rounded-2xl duration-150 px-2 py-2 hover:scale-110 font-medium text-[#3d3d3d] shadow-sm hover:bg-sky-400 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
