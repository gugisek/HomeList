...
<section class="font-[poppins] p-1">
    ...
    <div class="-mt-[45px] flex items-center justify-between">
        <h1 class="text-lg font-semibold text-gray-800">Dodaj zadanie</h1>
        <a class="flex items-center z-10 gap-2 hover:bg-green-400 cursor-pointer rounded-xl mr-9 p-1 px-3 ring-1 ring-green-400 text-green-400 hover:text-white duration-150 text-xs" onclick="addElement()">
